...
author:
- name: Michael Love
  affiliation: Department of Biostatistics, Dana-Farber Cancer Institute and Harvard School of Public Health, Boston, US
- name: Simon Anders
  affiliation:
...
`r Biocpkg("EBSeq")` [@Leng2013EBSeq] and
`r Biocpkg("BaySeq")` [@Hardcastle2010BaySeq].
@Schurch2016How compared performance of different statistical methods
