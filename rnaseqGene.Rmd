...
choice of psuedocount, now the genes with the very *lowest* counts
...
In the above function calls, we specify `blind=FALSE`, which means
...
```{r rldplot, fig.width=8, fig.height=3}
par(mfrow=c(1, 3))
