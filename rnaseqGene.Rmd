...
* [Annotating and exporting results](#annotate)
* [Accounting for unknown batches](#batch)
* [Time course experiments](#time)
* [Session information and references](#ref)
...
*edgeR*, *DSS* and others expect input data
as obtained, e.g., from RNA-Seq or another high-throughput
...
e.g. `SRR1039520`. We have also created a subdirectory, `aligned`,
...
less than 0.05 for each bin, and finally plot these ratios.
