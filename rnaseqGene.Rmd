...
also on its within-group variability, which *DESeq2* internally
quantifies using a parameter called *dispersion*.
For strongly expressed genes, the dispersion can be
