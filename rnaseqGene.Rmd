...
implemented in the *vst* function, is discussed alongside the *rlog*
in the *DESeq2* vignette.

**Note:** for large datasets (hundreds of samples), the variance
stabilizing transformation using *vst* will be much faster to compute.

The two transformations offered by DESeq2 are provided for
