...
As input, the *DESeq2* statistical method [@love2014] expects count
...
many reads have been mapped to gene *i* in sample *j*.  Analogously,
...
A note: here and elsewhere in the workflow, the parentheses `()` around the
entire code of the last line above is an R trick to print the output of the function
in addition to saving it to `sampleTable`. This is equivalent to saving
and then showing the object:
